...
class QHexWidget: public QPlainTextEdit {
    ...
    public:
       ...
       ~QHexWidget();
        ...
        void                        setMemoryMode           (QHexWidget::MemoryMode memoryMode);
        QHexWidget::MemoryMode      memoryMode              () const;
        QString                     memoryModeString        () const;

        void                        setCharMode             (QHexWidget::CharMode charMode);
        QHexWidget::CharMode        charMode                () const;
    ...
    private:
        ...
        QHexWidget::MemoryMode      _memoryMode;
        QHexWidget::CharMode        _charMode;
};
